...
_RENAMED_QUEUES: list[tuple[str, str, str]] = [
    ...
    ("crm.kassa.user.created", "kassa.user.created", "user.topic"),
    ("crm.kassa.user.updated", "kassa.user.updated", "user.topic"),
    ("crm.kassa.user.deactivated", "kassa.user.deactivated", "user.topic"),
